...
HD_PWD='C:/Users/karan/Downloads/DEC Lab/DEC Lab/VOTING_MACH/VOTING_MACH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voting_mach.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voting_mach.tcl -notrace
