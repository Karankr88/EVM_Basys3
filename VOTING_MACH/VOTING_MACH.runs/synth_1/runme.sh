...
HD_PWD='C:/Users/karan/Downloads/DEC Lab/DEC Lab/VOTING_MACH/VOTING_MACH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voting_mach.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voting_mach.tcl
